#!/bin/bash
#Generated on 2022-11-18 23:53:11 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=9d6853c7-a579-42f4-b2c2-4a9bfe5a9e94&pack=en-gb&edition=professional&aria2=2"
if [ $? != 0 ]; then
